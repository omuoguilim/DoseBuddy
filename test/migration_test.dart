...
void main() {
  ...
  test(
    'migration merges dose stores, preserves notes and retains source boxes',
    () async {
          ...
          takenLog: [
            {
              ...
              'takenAt': date.toIso8601String(),
            },
          ],
          sideEffects: [
            {'name': 'Legacy note', 'date': date},
          ],
        ),
      );
      await meds.close();
      ...
      await symptoms.put(
        's',
        SymptomEvent(id: 's', name: 'Headache', severity: 2, occurredAt: date),
      );
