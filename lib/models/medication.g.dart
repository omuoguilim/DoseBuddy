...
class MedicationAdapter extends TypeAdapter<Medication> {
  ...
  Medication read(BinaryReader reader) {
    ...
    return Medication(
      ...
      prescriber: (fields[23] as String?) ?? '',
      pharmacy: (fields[24] as String?) ?? '',
  ...
  void write(BinaryWriter writer, Medication o) {
    writer
      ...
      ..write(o.totalPills)
      ..writeByte(12)
      ..write(o.pillsRemaining)
      ..writeByte(13)
      ..write(o.refillThreshold)
      ..writeByte(14)
      ..write(o.lastRefillDate)
      ..writeByte(15)
      ..write(o.pillsPerDose)
      ..writeByte(16)
      ..write(o.dosageForm)
      ..writeByte(17)
      ..write(o.medicationType)
      ..writeByte(18)
      ..write(o.reason)
      ..writeByte(19)
      ..write(o.instructions)
      ..writeByte(20)
      ..write(o.foodInstruction)
      ..writeByte(21)
      ..write(o.startDate)
      ..writeByte(22)
      ..write(o.endDate)
